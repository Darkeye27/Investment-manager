...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
        <div class="container">
            <a class="navbar-brand fw-bold" href="{{ url('/') }}">Investment Manager</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    @auth
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ route('fixed-deposits.index') }}">Fixed Deposits</a></li>
    ...
    <footer class="bg-light text-center text-muted py-3 border-top">
        &copy; {{ date('Y') }} Investment Manager. All rights reserved.
    </footer>
